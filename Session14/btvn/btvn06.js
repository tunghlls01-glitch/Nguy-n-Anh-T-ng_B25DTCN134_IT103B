...
// sắp xếp tăng
let sort_increase = document.getElementById("sortIncrease");

sort_increase.addEventListener("click", function () {
...
// giảm
let sort_reduce = document.getElementById("sortReduce");

sort_reduce.addEventListener("click", function () {
    products.sort(function(a,b){
